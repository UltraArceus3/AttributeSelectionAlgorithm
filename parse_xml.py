...
# root = ET.Element("rla-config")

# gi = ET.Element("globalindex")
# root.append (gi)
# val = ET.SubElement(gi, "value")
# val.text = "0 1 2 3 4"

# we = ET.Element("weights")
# root.append(we)
# we_val = ET.SubElement(we,"value")
# we_val.text ="1 1 1 1 1"

# dataset = ET.Element("dataset")
# dataset.attrib["name"] = "dataset1"
# root.append(dataset)

# data_val = ET.SubElement(dataset,"value")
# data_val.text = "/home/nachiket/RLA_CL_EXTRACT/data/pse/pse_sample3.1.1"

# dataset_index = ET.SubElement(dataset,"dataset_index")

# dataset_index_v = ET.SubElement(dataset_index,"value")
# dataset_index_v.text = "0 1 2 3 4"
...
input_dict = prime_service['input_files']
